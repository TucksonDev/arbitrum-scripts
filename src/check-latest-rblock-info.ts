...
const main = async () => {
  ...
  const beforeStateconfirmData = utils.keccak256(
    utils.solidityPack(['bytes32', 'bytes32'], [beforeStateNodeInfo.l2BlockHash, beforeStateNodeInfo.sendRoot])
  );
  console.log('');
  console.log(`------------`);
  ...
  const afterStateconfirmData = utils.keccak256(
    utils.solidityPack(['bytes32', 'bytes32'], [afterStateNodeInfo.l2BlockHash, afterStateNodeInfo.sendRoot])
  );
  console.log('');
  console.log(`------------`);
